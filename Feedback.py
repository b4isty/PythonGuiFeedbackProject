...
headerlabel = ttk.Label(frame_header, text='Thanks for Coming to Our Restaurant', foreground='orange',
                        font=('Arial', 24))
headerlabel.grid(row=0, column=1)
messagelabel = ttk.Label(frame_header,
                         text='Please Give your feedBack below.It will help us to know in which portion we need to take care of',
